...
//        // self._writeDebug('Note: Movie added via JS method, static object/embed in-page markup method may work instead.');
  ...
  this._createMovie = function(smID,smURL) {
    ...
    var sHTML = '<div style="position:absolute;left:-256px;top:0px;width:1px;height:1px" class="movieContainer">'+html[self.isIE?0:1]+'</div>'+(self.debugMode && ((!self._hasConsole||!self.useConsole)||(self.useConsole && self._hasConsole && !self.consoleOnly)) && !document.getElementById(self.debugID)?'x'+debugHTML+toggleElement:'');
...
//    self._writeDebug('soundManager._createMovie(): trying to load <a href="'+smURL+'" title="Test this link (404=bad)">'+smURL+'</a>',1);
  ...
  this._writeDebug = function(sText,sType) {
    ...
    if (self._hasConsole && self.useConsole) {
      ...
      if (self.consoleOnly) return true;
    }
...
// Event.observe(window, 'unload', soundManager.destruct);

// soundManager.url = '/players/soundmanager2.swf';
// soundManager.debugMode = false;
// soundManager.consoleOnly = true;
// soundManager.nullURL = '/players/null.mp3';
